...
class td_qlearning:
      ...
      if file.endswith(".csv"):
        ...
        with open(filepath, newline='') as csvfile:
          ...
          for row in reader:
            ...
            # Initialize Q-values with rewards for non-terminal states
    ...
    for i in range(self.max_iterations):
      ...
      for trial_seq in self.trials:
        for k in range(len(trial_seq)):
          ...
          curr_reward = self.reward(curr_state)  # Use current state's reward
          ...
          if k + 1 < len(trial_seq):
            ...
            # If next state is terminal, use its reward as next_q
  ...
  def policy(self, state):
    ...
    if not actions:
      return 0
    q_vals = [(a, self.Q.get((state, a), 0)) for a in actions] # get Q-values for all available actions
    best_q = max(q_vals, key=lambda x: x[1])[1] # find the highest Q-value
...
# print("State: 6/1/6/-")
# print(" Q-value:", agent.qvalue("6/1/6/-", 2), " | Expected Q:", 0, "| Policy:", agent.policy("6/1/6/-"), " | Expected Policy:", 3)
# print()
...
# print("State: 2/8/3/-")
# print(" Q-value:", agent.qvalue("2/8/3/-", 2), " | Expected Q:", -9.00, "| Policy:", agent.policy("2/8/3/-"), " | Expected Policy:", 1)
# print()
...
# print("State: 4/4/5/-")
# print(" Q-value:", agent.qvalue("4/4/5/-", 1), " | Expected Q:", 0, "| Policy:", agent.policy("4/4/5/-"), " | Expected Policy:", 3)
# print()
...
# print("State: 11/0/2/-")
# print(" Q-value:", agent.qvalue("11/0/2/-", 2), " | Expected Q:", 0, "| Policy:", agent.policy("11/0/2/-"), " | Expected Policy:", 3)
# print()
...
# print("State: 9/1/3/-")
# print(" Q-value:", agent.qvalue("9/1/3/-", 3), " | Expected Q:", -4.37, "| Policy:", agent.policy("9/1/3/-"), " | Expected Policy:", 1)
# print()

# print("State: 4/4/5/-")
# print(" Q-value:", agent.qvalue("4/4/5/-", 2), " | Expected Q:", 0, "| Policy:", agent.policy("4/4/5/-"), " | Expected Policy:", 3)
# print()

# print("State: 4/3/6/-")
# print(" Q-value:", agent.qvalue("4/3/6/-", 1), " | Expected Q:", 0, "| Policy:", agent.policy("4/3/6/-"), " | Expected Policy:", 3)
# print()
...
# print("State: 2/4/7/-")
# print(" Q-value:", agent.qvalue("2/4/7/-", 1), " | Expected Q:", 0, "| Policy:", agent.policy("2/4/7/-"), " | Expected Policy:", 2)
# print()
...
# print("State: 4/6/3/-")
# print(" Q-value:", agent.qvalue("4/6/3/-", 2), " | Expected Q:", -7.29, "| Policy:", agent.policy("4/6/3/-"), " | Expected Policy:", 3)
# print()

# print("State: 13/0/0/-")
# print(" Q-value:", agent.qvalue("13/0/0/-", 2), " | Expected Q:", -3.28, "| Policy:", agent.policy("13/0/0/-"), " | Expected Policy:", 1)
# print()
